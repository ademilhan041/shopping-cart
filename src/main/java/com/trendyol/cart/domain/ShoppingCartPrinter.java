...
import com.trendyol.cart.domain.calculation.ShoppingCartCalculation;
...
public class ShoppingCartPrinter {
  ...
  public String prettyString(List<ShoppingCartItem> cartItems, ShoppingCartCalculation cartCalculation) {
